...
> [!IMPORTANT]  
> If you fork this repo to generate your own luacheck config file, you must add a secret to your repo settings named BMOS_SYNC_TOKEN containing a GitHub Personal Access Token.
